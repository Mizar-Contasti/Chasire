...
> Displays the title and the content of an Accordeon, is similar to card but the images are smaller.
...
```php
$aTitleArray = ["Title1"];
$aSubtitleArray = ["Subtitle1"];
$aTextArray = ["Inner Text1"];
$aImageArray = ["imageUrl1"];

webAccordion($aTitleArray, $aSubtitleArray, $aTextArray, $aImageArray)
```
...
$aTextArray = ["Inner Text1","Inner Text2"];
$aImageArray = ["imageUrl1","imageUrl2"];
...
> - Displays a Button that can be stacked indefinitely with other bsuttons.
...
> Displays a Citation with a Quote, it contains title subtitle and a link to the source.
...
```php
$cTitleArray = ["Title 1"];
$cSubtitleArray = ["Subtitle 1"];
$cUrlArray = ["https://citation.com"];

webCitation($cTitleArray, $cSubtitleArray, $cUrlArray);
```
...
```php
$cTitleArray = ["Title 1","Title 2"];
$cSubtitleArray = ["Subtitle 1","Subtitle 2"];
$cUrlArray = ["https://citation.com","https://citation.com"];
...
**Provides a link with a File**

> - Files support all formats, they are downloaded without being opened in the browsers
...
```php
$fTitleArray = ["Title"];
$fImageUrlArray = ["https://imageurl.com"];
$fFileUrlArray = ["https://fileurl.com"];

webFile($fTitleArray, $fImageUrlArray, $fFileUrlArray);
```
...
```php
$fTitleArray = ["Title","Title2"];
$fImageUrlArray = ["https://imageurl.com","https://imageurl.com"];
$fFileUrlArray = ["https://fileurl.com","https://fileurl.com"];
...
**Display the selected html**

> - Supports most of HTML Blocks
...
```php
$iTitleArray = ["Title1"];
$iSubtitleArray = ["Subtitle1"];
$iImageArray = ["https://imageurl.com"];
$iAnchorRefArray = ["https://hyperlink.com"];
$iAnchorTargetArray = ["_blank"];


webInfo($iTitleArray, $iSubtitleArray, $iImageArray, $iAnchorRefArray, $iAnchorTargetArray);
```
...
```php
$iTitleArray = ["Title1","title2"];
$iSubtitleArray = ["Subtitle1","subtitle2"];
$iImageArray = ["https://imageurl.com","https://imageurl.com"];
$iAnchorRefArray = ["https://hyperlink.com","https://hyperlink.com"];
$iAnchorTargetArray = ["_blank","_blank"];
...
> Display simple text without any format
...
> Displays a Video, mp4 video or loaded from url like youtube
...
$vTitleArray = ["Title1"];
$vUrlArray = ["https://videoUrl.com"];

webVideo($vTitleArray, $vUrlArray);
```
...
```php
$vTitleArray = ["Title1","title2"];
$vUrlArray = ["https://videoUrl.com","https://videoUrl.com"];
